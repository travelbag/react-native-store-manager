  ...
  async registerForPushNotificationsAsync() {
    ...
    if (Device.isDevice) {
      ...
      try {
        ...
        if (!projectId) {
          console.warn('⚠️ No EAS project ID found. Using development mode token.');
          // For development without EAS project ID, we can still get a token
      ...
      // Return null instead of showing alert in development
      return null;
    }
